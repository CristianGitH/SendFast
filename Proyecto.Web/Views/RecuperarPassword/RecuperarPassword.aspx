            ...
            <div class="card card-login mx-auto mt-5">
                ...
                <div class="card-body">
                    <div class="text-center mt-4 mb-5">
                        ...
                        <p>Ingrese su direccion de correo electronico y nosotros enviaremos las instrucciones para la recuperacion de su password.</p>
                    </div>
                </div>
                ...
                <asp:Button runat="server" ID="btnAceptar" CssClass="btn btn-primary" Text="Recuperar Password" OnClick="btnAceptar_Click" />
