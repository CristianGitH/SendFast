        ...
        protected void btnAceptar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dsConsulta.Tables[0].Rows.Count > 0)
                {
                    ...
                    stCuerpoHTML += "<img style='padding: 0; display: block' src='cid:tenor' width='100%' height='10%'>";
                    stCuerpoHTML += "</td>";
                    stCuerpoHTML += "</tr>";
                    stCuerpoHTML += "<tr>";
                    ...
                    Logica.Models.clsCorreo obclsCorreo = new Logica.Models.clsCorreo
                    {
                        ...
                        stTo = txtEmail.Text,
                        stImagen = Server.MapPath("~") + @"\Resources\Images\tenor.gif",
                        stIdImagen = "tenor",
                        stMensaje = stCuerpoHTML

                    };

                    obRecuperarPasswordController.setMailController(obclsCorreo);
                    ClientScript.RegisterStartupScript(this.GetType(), "Mensaje", "<script>swal('Mensaje!','Se realizo proceso con exito!' , 'success')</script>");
                }
                else throw new Exception("No se encontro informacion asociada a esa direccion de correo");
